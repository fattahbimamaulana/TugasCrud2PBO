...
<body>
                    ...
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        ...
                        <div class="login">
                            <button type="button" class="btn btn-secondary">
                                <a href="<?php echo e(route('login')); ?>" style="font-size: 15px" >Log in</a>
                            </button>
                        </div>
                        <br>
                        ...
                        <div class="register">
                            <button type="button" class="btn btn-secondary">
                                <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-300 dark:text-gray-150 underline" style="font-size: 15px">Register</a>
                            </button>
                        </div>
                                <?php endif; ?>
                        <?php endif; ?>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
      ...
      <?php echo $__env->yieldContent('main-nav'); ?>
...
</html><?php /**PATH C:\Users\LENOVO\Downloads\UTSOkkyPembasdat\UTSOkkyPembasdat\resources\views/layouts/mainpage.blade.php ENDPATH**/ ?>