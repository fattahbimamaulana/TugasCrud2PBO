...
} elseif ($_instance->childHasBeenRendered('3mSWDlI')) {
    $componentId = $_instance->getRenderedChildComponentId('3mSWDlI');
    $componentTag = $_instance->getRenderedChildComponentTagName('3mSWDlI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3mSWDlI');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('3mSWDlI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
